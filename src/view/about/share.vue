  ...
  <div>
    ...
    <div class="container nav-slide-body-content">
      <div class="nav-slide-body-content-point">
        <span @click="handleScrool(1)" class="nav-slide-body-content-point-item"
              :class="scrollIndex === 1 ? 'nav-slide-body-content-point-active' : ''"></span>
        <span @click="handleScrool(2)" class="nav-slide-body-content-point-item"
              :class="[scrollIndex === 2 ? 'nav-slide-body-content-point-active' : '']"></span>
        <span @click="handleScrool(3)" class="nav-slide-body-content-point-item"
              :class="[scrollIndex === 3 ? 'nav-slide-body-content-point-active' : '']"></span>
        <span @click="handleScrool(4)" class="nav-slide-body-content-point-item"
              :class="[scrollIndex === 4 ? 'nav-slide-body-content-point-active' : '']"></span>
        <span @click="handleScrool(5)" class="nav-slide-body-content-point-item"
              :class="[scrollIndex === 5 ? 'nav-slide-body-content-point-active' : '']"></span>
        <span @click="handleScrool(6)" class="nav-slide-body-content-point-item"
              :class="[scrollIndex === 6 ? 'nav-slide-body-content-point-active' : '']"></span>
        <span @click="handleScrool(7)" class="nav-slide-body-content-point-arr"></span>
      </div>
    </div>
...
<style scoped>
  ...
  .nav-slide-body-content{
    position: relative;
  }
  .nav-slide-body-content-point{
    width: 18px;
    height: 190px;
    position: fixed;
    right: 48px;
  ...
  .nav-slide-body-content-point-active{
    background: #f4bdca;
  }
  .nav-slide-body-content-point-item{
    width: 16px;
    height: 16px;
    border: 2px solid #f4bdca;
    display: block;
    margin-bottom: 18px;
    border-radius: 50%;
    cursor:pointer;
  }
  .nav-slide-body-content-point-arr{
    width: 0;
    height: 0;
    top: -18px;
    left: -2px;
    ...
    border-bottom: 21px solid #f4bdca;
    cursor:pointer;
  }
  ...
  .banner{
    ...
    height: 653px;
    margin: 0 auto;
    background-image: url("../../../static/image/share-banner.jpg");
  ...
  .business{
    ...
    margin: 0 auto;
    padding-top: 60px;
    background-image: url("../../../static/image/share01.png");
    background-size: cover;
    background-position: center center;
    background-repeat: no-repeat;
  }
  ...
  .middle-banner{
    ...
    margin: 0 auto;
    padding-top: 60px;
    background-image: url("../../../static/image/share02.jpg");
    background-size: cover;
    background-position: center center;
    background-repeat: no-repeat;
  }
  ...
  .server{
    ...
    padding-top: 60px;
    margin: 0 auto;
    background-image: url("../../../static/image/share05.jpg");
    background-size: cover;
    background-position: center center;
    background-repeat: no-repeat;
  ...
  .server-bg{
    ...
    height: 562px;
    margin: 0 auto;
    background-image: url("../../../static/image/share03.jpg");
  ...
  .case-carousel-agency{
    position: absolute;
    left: 98px;
    top: 26px;
  }

  .case-carousel-agency-image{
    position: relative;
    cursor: pointer;
    z-index: 99;
  }
  ...
  .case-carousel .swiper-button-prev:focus{
  ...
  .case-carousel .swiper-button-next:focus{
    outline: none !important;
  }
  ...
  .join{
    ...
    height: 572px;
    margin: 0 auto;
    background-image: url("../../../static/image/share04.png");
    background-size: cover;
    background-position: center center;
    background-repeat: no-repeat;
  }
